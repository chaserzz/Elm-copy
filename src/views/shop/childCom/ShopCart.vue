...
<template>
  <div class='ShopCart'>
    <section class='CartDetail' v-if='showDetail'>
      <transition name="fade">
        <div @click='blockClick' class='block'></div>
      </transition>
          ...
          <ul class='detailList'>
            <li v-for='(item,index) in cartData' :key='index'>
              <section>
                ...
                <div class='foodnum'>
                  <!-- 减号 -->
                  <svg @click='subToCart(item)' t="1595580263309" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="6695" width="19" height="19">
                    <path
                  ...
                  <!--加号 -->
                  <svg @click='addToCart(item)' t="1595580245577" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="6413" width="19" height="19">
                    <path
    ...
    <div class='BottomBar'>
      <div class='shopSvg' @click='shopCartClick' :class='{move_in_cart : receive,active : cartData.length != 0}'>
        <div class='totalnum' v-if='cartData.length > 0'>
          {{totalGoods}}
        </div>
        <svg t="1595664674549" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="4951" width="1.7rem" height="1.7rem">
          <path
            d="M350.72 777.46086957q19.03304348 0 36.0626087 7.01217391t30.05217391 19.53391304 20.03478261 29.55130435 7.01217391 36.0626087-7.01217391 36.06260869-20.03478261 29.55130435-30.05217391 20.03478261-36.0626087 7.51304348q-20.03478261 0-36.56347826-7.51304348t-29.55130435-20.03478261-20.03478261-29.55130435-7.01217391-36.06260869 7.01217391-36.0626087 20.03478261-29.55130435 29.55130435-19.53391304 36.56347826-7.01217391zM767.44347826 779.46434783q19.03304348 0 36.56347826 7.01217391t30.05217391 19.53391304 20.03478261 29.55130435 7.51304348 36.0626087-7.51304348 36.06260869-20.03478261 29.55130435-30.05217391 20.03478261-36.56347826 7.51304348-36.06260869-7.51304348-29.55130435-20.03478261-20.03478261-29.55130435-7.51304348-36.06260869 7.51304348-36.0626087 20.03478261-29.55130435 29.55130435-19.53391304 36.06260869-7.01217391zM935.73565217 210.47652174q28.04869565 0 43.57565218 7.51304348t22.03826087 18.53217391 6.01043478 23.54086957-3.50608696 21.5373913-12.52173913 37.06434783-21.5373913 61.60695652-23.54086957 66.61565217-17.53043478 52.09043478q-13.0226087 40.06956522-33.0573913 55.59652174t-49.08521739 15.52695653l-34.05913044 0-65.11304348 0-85.14782608 0-93.16173914 0-248.43130434 0 15.02608695 90.15652173 504.87652174 0q48.08347826 0 48.08347826 41.07130435 0 20.03478261-9.51652174 34.56t-37.56521739 14.52521739l-48.08347826 0-93.16173913 0-115.2 0-117.20347826 0-96.16695652 0-55.09565217 0q-20.03478261 0-33.55826087-9.01565217t-22.53913044-23.54086957-14.52521739-31.5547826-8.51478261-32.05565218q-1.00173913-6.01043478-5.50956522-29.05043478t-11.01913043-57.6-14.52521739-77.13391304-16.02782609-85.64869566q-19.03304348-101.17565217-43.07478261-225.39130434l-75.13043478 0q-15.02608696 0-25.04347826-7.51304348t-16.52869565-18.03130435-9.01565218-22.53913044-2.50434782-22.03826086q0-20.03478261 13.52347826-33.05739131t36.56347826-13.02260869l22.03826087 0 20.03478261 0 25.04347826 0 34.05913043 0q20.03478261 0 32.05565218 6.01043478t19.03304347 15.02608695 10.01739131 19.03304348 5.00869565 17.02956522q2.00347826 8.01391304 4.00695652 22.53913043t4.00695652 29.55130435q3.00521739 18.03130435 6.01043479 38.06608696l685.18956521 0z"
            fill="#ffffff" p-id="4952"></path>
        </svg>
      </div>
      <section class='left'>
        <p class='goods_price'>
        ...
        <div class='total_price' @click='goConfirm()' :class='{goPay : goPay}'>
          <span>{{payText}}</span>
        </div>
      </section>
    </div>
