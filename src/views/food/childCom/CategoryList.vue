        ...
        <transition name="showlist">
          <section v-show='sortBy == "food"' class='sort_content food'>
            <ul class='category_left'>
                <li class='categorys' v-for='(item,index) in categoryList' :key='index' @click='categoryClick(index)' :class='{detail_active : index === currentIndex}'>
                    <div>
                ...
                <ul class='category_right'>
                    <scroll id='Scroll'>
                    <li v-if='index' v-for='(item,index) in detailList'  class='detailItem' @click='changClick(item)'>
          ...
          <section v-show='sortBy == "divide"' class='sort_content divide'>
            ...
            <ul>
                <li @click='divideClick()'>
                    <svg t="1595309394674" class="icon" v-if='chose' viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3552" width="13" height="13"><path d="M1018.88 240.64l-72.704-72.704-542.72 543.232-326.144-325.632L5.12 457.728l398.336 398.336 72.192-72.704L1018.88 240.64z" p-id="3553" fill="#1296db"></path></svg>
                    <svg t="1595310057800" class="icon" v-else viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5711" width="14" height="14"><path d="M924.8 461.792l-128.496 6.624-109.296 22.896s-15.312 88.464-67.92 150.672c-40.608 48-101.136 99.648-187.584 118.896 0 0-36.912 8.832-55.392 54.624s-48.528 135.12-48.528 135.12L249.824 992l228.48-420.912S208.496 471.392 99.2 195.2l470.4 227.424s52.416-51.648 127.584-53.136c0 0 73.104 2.928 79.728 80.496z" fill="#1296db" p-id="5712"></path><path d="M314.816 32l247.392 352.224-247.392-255.504S308.384 43.808 314.816 32zM202.784 93.296l352.224 304.224-326.4-193.44s-32.688-65.76-25.824-110.784zM162.704 375.392L185.6 401.216a164.832 164.832 0 0 0 42.096 141.072A229.152 229.152 0 0 0 396.8 620.576s-156.576 25.104-225.216-131.472c0 0-22.176-56.88-8.88-113.712z" fill="#1296db" p-id="5713"></path></svg>
                    <span>蜂鸟快送</span>
