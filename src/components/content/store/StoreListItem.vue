      ...
      <div class='second'>
        ...
        <div class='start-container'>
          <div class='totalstart'>
            <svg t="1594708448640" v-for='num in 5' :key='num' viewBox="0 0 1024 1024" version="1.1"
              xmlns="http://www.w3.org/2000/svg" p-id="2888" width="0.6rem" height="0.6rem">
              <path
